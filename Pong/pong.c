...
int main(void)
{
    ...
    while (!WindowShouldClose())
    {
        ...
        if (IsKeyDown(KEY_S)) paddlePosition.y += 3.0f;
        if (IsKeyDown(KEY_W)) paddlePosition.y -= 3.0f;
        if (IsKeyDown(KEY_UP)) paddlePosition2.y -= 3.0f;
        if (IsKeyDown(KEY_DOWN)) paddlePosition2.y += 3.0f;
